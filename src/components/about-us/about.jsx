  ...
  return (
    <section id="about" className={styles.container}>
      <div className={styles.aboutUs__columns}>
        ...
        <div className={styles.aboutUs__column}>
          <img className={styles.aboutUs__image} src={aboutImageRight} alt="фото квартиры" />
          <div className={styles.aboutUs__border} />
        </div>
      </div>
      <div className={styles.aboutUs__columns}>
        <div className={styles.aboutUs__column}>
          <img className={styles.aboutUs__image} src={aboutImageLeft} alt="фото квартиры" />
          <div className={`${styles.aboutUs__border} ${styles.aboutUs__border_bottom}`} />
        </div>
        <div className={`${styles.aboutUs__column} ${styles.aboutUs__column_bottom}`}>
          <p className={styles.aboutUs__paragraph}>
