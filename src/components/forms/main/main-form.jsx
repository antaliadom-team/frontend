      ...
      return (
        <>
          <li className={styles.item}>
            <Dropdown text={"Аренда/Покупка"} options={["Аренда", "Покупка"]} required={true} />
          </li>
          <li className={styles.item}>
            <Dropdown text={"Локация"} options={["Анталия", "Северный Кипр", "Стамбул", "другое"]} required={false} />
          </li>
          <li className={styles.item}>
            <Dropdown
          ...
          <li className={styles.item}>
            <Dropdown text={"Количество комнат"} options={["1", "2", "3", "4+"]} required={false} />
          </li>
        </>
      );
    } else {
      ...
      <div className={styles.container}>
        ...
        <form className={styles.form}>
          <ul className={styles.list}>
            ...
            <li className={styles.item}>
              <PhoneInput text={"Номер телефона*"} placeholder={"+7 999 123 45 67"} />
            </li>
            <li className={styles.item}>
