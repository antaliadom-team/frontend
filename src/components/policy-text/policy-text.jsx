...
const PolicyText = () => {
    return (
        <div className={styles.policy}>
            <h1 className={styles.policyTitle}>Политика конфиденциальности и условия использования сервисам</h1>
            <span className={styles.policyText}>
                ...
                правила использования Администрацией сайта персональной информации Пользователя, предоставляемой им при
                использовании сайта, расположенного по адресу: https://www.анталиядом.com/ Использование сервисов Сайта
                означает безоговорочное согласие Пользователя с настоящей Политикой и указанными в ней условиями
