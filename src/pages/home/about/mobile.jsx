        ...
        <article id="about" className={styles.container}>
            ...
            <div className={styles.article}>
                ...
                <p className={styles.paragraph}>
                    ...
                    работы с&nbsp;недвижимостью, сделав этот процесс приятным для&nbsp;наших клиентов. Команда компании
                    состоит из&nbsp;реальных людей с реальным опытом, сочетающих в себе профессионализм и знание нюансов
                    рынка.
                </p>
            </div>
            ...
            <div className={styles.article_bottom}>
                <p className={styles.paragraph}>
                    <span>Мы понимаем,</span> вы принимаете чрезвычайно важное решение и&nbsp; вам нужны люди, которым
                    вы можете доверять.
                </p>
                <p className={styles.paragraph}>
                    <span>Мы поможем</span> вам найти идеальное место и&nbsp;позаботимся о том, чтобы вы связали с ним
                    будущее.
                </p>
                <p className={styles.paragraph}>
